...
contract_filter = st.selectbox("Contract Duration", options=[1, 2, 3], index=0)
output_filename = st.text_input("Output file name (without .xlsx)", value="multi_site_quote")

# --- Multi-meter input table ---
        ...
        if postcode and kwh > 0:
            ...
            if not match.empty:
                ...
                results.append({
                    ...
                    "LDZ": "Not found",
                    "Exit Zone": "Not found",
                    "Contract_Duration": contract_filter,
                    "Product_Name": "",
