...
if uploaded_file:
    ...
    # Define 7 default bands
    default_bands = [
        {"Min": 0, "Max": 999, "Uplift": 6.0},
        {"Min": 1000, "Max": 24999, "Uplift": 5.0},
        {"Min": 25000, "Max": 49999, "Uplift": 4.0},
        {"Min": 50000, "Max": 73199, "Uplift": 3.0},
        {"Min": 73200, "Max": 124999, "Uplift": 2.5},
        {"Min": 125000, "Max": 292999, "Uplift": 2.0},
        {"Min": 293000, "Max": 731999, "Uplift": 1.5},
    ]

    band_inputs = []

    with st.container():
        with st.expander("Click to edit all 7 bands (scrollable)", expanded=True):
