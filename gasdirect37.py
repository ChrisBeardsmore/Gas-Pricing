# Gas Direct V3.8 (Full Logic Applied to Input Grid)
# ---------------------------------------------------------------------------------
# Scrollable input table with full postcode -> LDZ match, flat file pricing, uplift, and TAC calcs
# ---------------------------------------------------------------------------------
...
if uploaded_file:
    ...
    for _, row in edited_data.iterrows():
        ...
        for duration in [12, 24, 36]:
            ...
            result_row[f"TAC £ ({duration}m)"] = tac
