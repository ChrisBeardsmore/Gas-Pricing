# Gas Direct V3.5 (True Horizontal Scroll for Input Rows)
# ---------------------------------------------------------------------------------
...
# - ✅ TRUE horizontal scroll per input site row
# ---------------------------------------------------------------------------------
...
if uploaded_file:
    ...
    for i in range(10):
        ...
        # Start a horizontal scrollable container
        st.markdown(f"""
        <div style='overflow-x:auto; white-space:nowrap; padding:1rem; border-bottom:1px solid #ccc;'>
